...
class RealtimeConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data=None, bytes_data=None):
        ...
        if action == "chat_message":
            receiver_message = data.get("message_receiver")
            sender_message = data.get("message_sender")

            if not receiver_message or not sender_message:
                return 
    ...
    async def chat_event(self, event):
        await self.send(text_data=json.dumps({
            "type": "chat",
            "message_sender": event.get("sender_message"),
            "message_receiver": event.get("receiver_message"),
    ...
    def save_message(self, receiver_message, sender_message, to_user_id):
        ...
        msg = Message.objects.create(
            ...
            receiver=receiver,
            message_type="text",
            encrypted_text_sender=sender_message,   # message for sender
            encrypted_text_receiver=receiver_message, # message for receiver
            is_delivered=True
        )
