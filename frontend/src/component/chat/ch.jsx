  ...
  const fetchMessages = async (convId) => {
    ...
    try {
      ...
      const formatted = res.data.map((m) => ({
        ...
        media: m.file
          ? {
              url: `${AxiosInstance.defaults.baseURL}${m.file}`,
              type: m.message_type
            }
          : null,
    ...
    (data) => {
      ...
      if (data.type === "chat") {
        ...
        const newMsg = {
          ...
          media: data.file
            ? {
                url: `${AxiosInstance.defaults.baseURL}${data.file}`,
...
const sendAudio = async (blob) => {
  ...
  try {
    ...
    console.error("Audio upload error", err.response?.data || err);
                ...
                <div className="chat-message-body">
                  ...
                  {m.media ? (
                    ...
                    <div className="chat-media">
                      ...
                      {m.media.type === "image" && (
                        <img src={m.media.url} alt="sent" className="chat-image"/>
                      )}

                      {m.media.type === "video" && (
                        <video src={m.media.url} controls className="chat-video"/>
                      )}

                      {m.media.type === "audio" && (
                        <audio src={m.media.url} controls className="chat-audio"/>
                      )}
